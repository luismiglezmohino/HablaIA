  ...
  <div class="border-b border-surface-200 bg-white px-4 py-3">
    <div class="relative">
      ...
      <input
        ...
        autocomplete="off"
        class="min-h-touch w-full rounded-xl border-2 border-surface-400 bg-surface-50 py-3 pl-12 pr-10 text-base shadow-soft transition-all placeholder:text-surface-300 focus:border-primary-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:shadow-card"
        @focus="emit('focus')"
        @blur="emit('blur')"
