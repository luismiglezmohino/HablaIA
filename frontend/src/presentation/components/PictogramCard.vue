...
<template>
  <div
    ...
    class="group rounded-2xl border border-surface-400 border-t-[5px] shadow-card motion-safe:transition-all motion-safe:duration-200 motion-safe:hover:shadow-card-hover motion-safe:hover:-translate-y-1 focus-within:z-[15] focus-within:shadow-card-hover focus-within:-translate-y-1"
  >
    <button
      :aria-label="`Pictograma ${props.pictogram.label}`"
      :disabled="props.disabled"
      class="min-h-touch min-w-touch flex w-full flex-col items-center overflow-hidden rounded-2xl text-center transition-colors focus:outline-none focus-visible:ring-4 focus-visible:ring-primary-500 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-40"
